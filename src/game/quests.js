  ...
  onBlockPlaced(blockName) {
    if (this.stage === "PLACE_BENCH" && blockName === "workbench") {
      ...
      this.game.ui.dialogue.play(
        ...
        () => {
          this.busy = false;
          this.game.blueprints.activate("hut", PLACES.hut, this.game.world.pristineSurfaceY(PLACES.hut.x + 2, PLACES.hut.z + 1));
  ...
  onTalk(villagerId) {
    ...
    if (this.stage === "MEET_MINA" && villagerId === "mina") {
      ...
      this.game.ui.dialogue.play(
        ...
        () => {
          this.busy = false;
          this.game.blueprints.activate("farm", PLACES.farm, this.game.world.pristineSurfaceY(PLACES.farm.x + 2, PLACES.farm.z + 1));
      ...
      this.game.ui.dialogue.play(
        ...
        () => {
          ...
          this.game.blueprints.activate(
            "shrine",
            PLACES.shrine,
            this.game.world.pristineSurfaceY(PLACES.shrine.x + 2, PLACES.shrine.z + 2),
          );
